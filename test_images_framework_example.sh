...
sudo docker build --force-rm --build-arg SSH_PRIVATE_KEY="$(cat ~/.ssh/id_ed25519)" -t images_framework_image .
...
rsync --delete -azvv /var/lib/docker/volumes/images_framework_volume/_data/images_framework/output/images/ output/images
